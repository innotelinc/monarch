...
| Guide (EPG) | `monarch-init` + `iptv` container | channel list at `/opt/epg/channels.xml` (assembled from `LIVETV_EPG_SITES`); guide grabbed twice a day and served at `http://iptv:3000/guide.xml` |
